...
const Navbar = () => {
  ...
  return (
    <div className='grid lg:mx-24 py-2.5'>
      <div className='grid  lg:grid-cols-4 items-center bg text-sm'>
        <div className='grid grid-cols-2 lg:grid-cols-1'>
          ...
          <p className='text-[32px] font-bold whitespace-nowrap text-center'>SHOP.CO</p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-2 '>
          <div>
            <p className='grid lg:justify-end'>
