...
const Navbar = () => {
  ...
  return (
    <div className='grid mx-24 items-center'>
      <div className='grid grid-cols-4 bg text-sm'>
        <div className='grid grid-cols-2 lg:grid-cols-1'>
          ...
          <p className='text-[32px] font-bold whitespace-nowrap'>SHOP.CO</p>
        </div>
        ...
        <div className='hidden lg:flex items-center'>
          <div className="relative w-full">
            ...
            <input
              ...
              className="border rounded pl-10 pr-2 py-1 w-full"
            />
          </div>
        </div>
